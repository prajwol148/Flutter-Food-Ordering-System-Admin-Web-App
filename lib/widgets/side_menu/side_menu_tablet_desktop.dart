    ...
    return Container(
      decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [Colors.red, Colors.indigo.shade600],
          ),
          boxShadow: [
            BoxShadow(
          ...
          children: [
            ...
            SideMenuItemDesktop(
              ...
              onTap: () {
                ...
                locator<NavigationService>().navigateTo(HomeRoute, context);
              },
            ),
            SideMenuItemDesktop(
              icon: Icons.people,
              ...
              onTap: () {
                ...
                locator<NavigationService>().navigateTo(UsersRoute, context);
              },
            ),
            SideMenuItemDesktop(
              ...
              onTap: () {
                ...
                locator<NavigationService>().navigateTo(OrdersRoute, context);
              },
            ),
            SideMenuItemDesktop(
              ...
              onTap: () {
                ...
                locator<NavigationService>().navigateTo(ProductsRoute, context);
              },
            ),
            SideMenuItemDesktop(
              icon: Icons.category,
              ...
              onTap: () {
                ...
                locator<NavigationService>()
                    .navigateTo(CategoriesRoute, context);
              },
            ),
            SideMenuItemDesktop(
              icon: Icons.category,
              ...
              onTap: () {
                ...
                locator<NavigationService>().navigateTo(BrandsRoute, context);
              },
            ),
          ],
        ),
