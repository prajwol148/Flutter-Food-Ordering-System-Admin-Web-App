            ...
            child: Card(
              ...
              child: ResponsiveDatatable(
                title: !tablesProvider.isSearch
                    ...
                    : null,
                actions: [
                  if (tablesProvider.isProductSelected)
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => EditProduct(product: tablesProvider.selecteds[0],)),
                      );
                    },
                  ),
                  if (tablesProvider.isProductSelected)
                  IconButton(
                    ...
                    onPressed: () {
                      tablesProvider.deleteProductItems();
                    },
                  ),
                ...
                onSelect: tablesProvider.onProductSelected,
