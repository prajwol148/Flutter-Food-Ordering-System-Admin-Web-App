          ...
          Container(
            ...
            child: Card(
              ...
              child: ResponsiveDatatable(
                actions: [
                  if (tablesProvider.currentOrderStatus == 'Done')
                    Row(
                      children: [
                        IconButton(
                            icon: Icon(
                            ...
                            onPressed: () {
                              tablesProvider.currentOrderStatus = 'Accepted';
                              setState(() {});
                            }),
                        SizedBox(
                          width: 10,
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            tablesProvider.deleteOrderItems();
                            tablesProvider.currentOrderStatus = 'Deleted';
                          },
                        )
                      ],
                    ),
                  if (tablesProvider.currentOrderStatus == 'Accepted' ||
                      tablesProvider.currentOrderStatus == 'Deleted')
                    IconButton(
                      icon: Icon(
                        Icons.check_circle,
                ...
                onSelect: tablesProvider.onOrderSelected,
