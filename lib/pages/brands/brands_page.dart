...
import 'package:ecommerce_admin_tut/pages/brands/add_brand.dart';
import 'package:ecommerce_admin_tut/pages/brands/edit_brand.dart';
              ...
              child: ResponsiveDatatable(
                title: !tablesProvider.isSearch
                    ? RaisedButton.icon(
                        ...
                        icon: Icon(Icons.add),
                        label: Text("Add Food Type"))
                    : null,
                actions: [
                  if (tablesProvider.isBrandSelected)
                    IconButton(
                      icon: Icon(
                        Icons.edit,
                        color: Colors.green,
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => EditBrand(
                                    product: tablesProvider.selecteds[0],
                                  )),
                        );
                      },
                    ),
                  if (tablesProvider.isBrandSelected)
                    IconButton(
                      ...
                      onPressed: () {
                        tablesProvider.deleteBrandItems();
                      },
                    ),
                ...
                onSelect: tablesProvider.onBrandSelected,
