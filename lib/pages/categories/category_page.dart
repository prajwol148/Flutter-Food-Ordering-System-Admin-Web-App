...
import 'package:ecommerce_admin_tut/pages/categories/add_category.dart';
import 'package:ecommerce_admin_tut/pages/categories/edit_category.dart';
                ...
                child: Card(
                  ...
                  child: ResponsiveDatatable(
                    title: !tablesProvider.isSearch
                        ...
                        : null,
                    actions: [
                      if (tablesProvider.isCategorySelected)
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => EditCategory(product: tablesProvider.selecteds[0],)),
                            );
                          },
                        ),
                      if (tablesProvider.isCategorySelected)
                        IconButton(
                          ...
                          onPressed: () {
                            tablesProvider.deleteCategoryItems();
                          },
                        ),
                    ...
                    onSelect: tablesProvider.onCategorySelected,
